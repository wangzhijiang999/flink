...
public class RecordWriterTest {
	...
	static class CollectingPartitionWriter implements ResultPartitionWriter {
		...
		@Override
		public boolean addBufferConsumer(BufferConsumer buffer, int targetChannel, boolean isBarrierEvent) throws IOException {
	...
	private static class RecyclingPartitionWriter implements ResultPartitionWriter {
		...
		@Override
		public boolean addBufferConsumer(BufferConsumer bufferConsumer, int targetChannel, boolean isBarrierEvent) throws IOException {
