...
public abstract class NettyMessage {
	...
	static class PartitionRequest extends NettyMessage {
		...
		void write(ChannelOutboundInvoker out, ChannelPromise promise, ByteBufAllocator allocator) throws IOException {
			...
			writeToChannel(out, promise, allocator, consumer, ID, LENGTH);
		}
	...
	static class TaskEventRequest extends NettyMessage {
		...
		void write(ChannelOutboundInvoker out, ChannelPromise promise, ByteBufAllocator allocator) throws IOException {
			...
			writeToChannel(out, promise, allocator, consumer, ID, LENGTH + serializedEvent.remaining());
		}
	...
	static class CancelPartitionRequest extends NettyMessage {
		...
		@Override
		void write(ChannelOutboundInvoker out, ChannelPromise promise, ByteBufAllocator allocator) throws IOException {
			writeToChannel(out, promise, allocator, receiverId :: writeTo, ID, LENGTH);
		}
	...
	static class CloseRequest extends NettyMessage {
		...
		@Override
		void write(ChannelOutboundInvoker out, ChannelPromise promise, ByteBufAllocator allocator) throws IOException {
			writeToChannel(out, promise, allocator, ignored -> {}, ID, LENGTH);
		}
	...
	static class AddCredit extends NettyMessage {
		...
		private static final byte LENGTH = 4 + 16;
