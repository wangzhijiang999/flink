...
/**
 * The {@link AlignedCheckpointedInputGate} uses {@link CheckpointBarrierHandler} to handle incoming
 * {@link CheckpointBarrier} from the {@link InputGate}.
 */
@Internal
public class AlignedCheckpointedInputGate implements CheckpointedInputGate {

	private static final Logger LOG = LoggerFactory.getLogger(AlignedCheckpointedInputGate.class);
	...
	public AlignedCheckpointedInputGate(
			InputGate inputGate,
